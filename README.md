...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-jbmdah0.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-jbmdah0.containers.anotherwebservice.com/
...
```
git clone git@github.com:coinZee/container-jbmdah0.git
cd container-jbmdah0
```
...
```
docker attach container-jbmdah0
```
